        ...
        <CardContent className="p-6">
          <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
            <div className="space-y-1">
              <p className="font-heading text-lg font-semibold">Publish</p>
              <p className="text-sm text-muted-foreground">
                Open registration and share your event link with players.
              </p>
            </div>
      ...
      <CardContent className="space-y-5">
        {subscribed && (
          <p className="rounded-lg border border-primary/30 bg-primary/5 px-3 py-2 text-sm text-primary">
            Course Plan activated — you can publish this event for free, or any
            future events at no per-event cost.
          </p>
        )}
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          >
            <div className="flex items-center justify-between gap-2">
              ...
              <span className="text-sm font-medium text-primary">{eventFee}</span>
            </div>
